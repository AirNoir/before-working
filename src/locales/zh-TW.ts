...
export default {
  ...
  settings: {
    ...
    account: {
      ...
      purchaseTitle: '選擇購買方式',
      purchaseLifetime: '一次性購買 (NT$ 60)',
      purchaseMonthly: '月度訂閱 (NT$ 50/月)',
      purchaseYearly: '年度訂閱',
      purchaseSuccess: '購買成功',
      purchaseSuccessMessage: '您已成功升級到付費版！',
      purchaseFailed: '購買失敗',
      purchaseCanceled: '購買已取消',
      restorePurchases: '恢復購買',
      restoreSuccess: '恢復成功',
      restoreSuccessMessage: '已恢復您的購買內容！',
      restoreFailed: '恢復失敗',
      restoreNotFound: '未找到已購買的內容',
      devMode: '開發模式',
      switchToFree: '切換到免費版',
