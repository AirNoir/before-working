...
export const GROUP_TEMPLATES: GroupTemplate[] = [
  {
    ...
    items: [
      ...
      {title: '水壺', icon: 'cup-water'},
      {title: '毛巾', icon: 'texture-box'},
      {title: '運動包', icon: 'bag-personal'},
  ...
  },
  {
    ...
    items: [
      {title: '尿布', icon: 'baby-carriage'},
      {title: '濕紙巾', icon: 'cube-outline'},
      {title: '奶瓶', icon: 'baby-bottle'},
      {title: '奶粉', icon: 'baby-bottle'},
      {title: '換洗衣物', icon: 'tshirt-crew'},
      {title: '玩具', icon: 'cube-outline'},
      {title: '推車', icon: 'car'},
      {title: '水壺', icon: 'cup-water'},
      {title: '小毯子', icon: 'rug'},
  ...
  },
  {
    ...
    items: [
      {title: '登山包', icon: 'bag-personal'},
      {title: '登山鞋', icon: 'shoe-sneaker'},
      {title: '水壺', icon: 'cup-water'},
      {title: '食物', icon: 'food-apple'},
  ...
  },
  {
    ...
    items: [
      ...
      {title: '身份證', icon: 'card-account-details'},
      {title: '錢包', icon: 'wallet'},
      {title: '手機', icon: 'cellphone'},
  ...
  },
  {
    ...
    items: [
      ...
      {title: '食物', icon: 'food-apple'},
      {title: '水', icon: 'cup-water'},
      {title: '炊具', icon: 'pot-steam'},
      {title: '手電筒', icon: 'flashlight'},
      {title: '急救包', icon: 'medical-bag'},
      {title: '手機', icon: 'cellphone'},
      {title: '行動電源', icon: 'battery-charging'},
  ...
  },
  {
    ...
    items: [
      ...
      {title: '食物', icon: 'food-apple'},
      {title: '飲料', icon: 'cup'},
      {title: '餐具', icon: 'silverware-fork-knife'},
      {title: '垃圾袋', icon: 'bag-personal'},
      {title: '濕紙巾', icon: 'cube-outline'},
      {title: '手機', icon: 'cellphone'},
      {title: '相機', icon: 'camera'},
    ],
